...
# 🟢 FIX 1: Standardized regex to match the middleware exactly
TENANT_REGEX = re.compile(r"^rest_[a-z0-9]+$")

# 🟢 FIX 2: Dynamically pull the service name to prevent schema collisions
...
def provision_tenant(tenant_id: str):
    ...
    # Construct the target schema (e.g., 'kitchen_rest_123')
